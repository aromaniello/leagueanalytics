class Build < ApplicationRecord
  ...
  validates :champion,
            ...
            presence: true
  validates :level,
            inclusion: { in: 1..18, message: "level must be between 1 and 18" },
            presence: true
  validates :q_level, :w_level, :e_level,
            inclusion: { in: 1..5, message: "q, w and e level must be between 1 and 5" },
            presence: true
  validates :r_level,
            inclusion: { in: 1..3, message: "r level must be between 1 and 3" },
            presence: true
